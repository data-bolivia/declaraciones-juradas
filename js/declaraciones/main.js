$(document).ready(function () {
    ...
    function filtar_datos_de_funcionarios() {
        var divs_con_funcionarios = $('div#with-datos div.confuncioario');
